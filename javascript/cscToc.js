 ...
 * Details : Table of Content for csc
 * Owner : Romeo89
 * Website : https://www.cscplus.work
 */
function shortCodeCSC(t, n, i) {
...
}(window.jQuery), $("div#toccsc").each(function() {
    var div = $(this);
    var n = div.attr("value-title");
    if (n) {
        n = (n !== "") ? n : "Table of Contents";
        div.replaceWith('<div class="toccsc-wrap"><div class="toccsc-inner"><a href="javascript:;" class="toccsc-title" role="button" title="' + n + '">' + n + '</a><ol id="toc"></ol></div></div>');
        $(".toccsc-title").each(function() {
            var t = $(this);
            t.on("click", function() {
