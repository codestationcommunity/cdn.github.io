...
function n(n) {
    if ((document.layers || document.getElementById && !document.all) && (2 == n.which || 3 == n.which)) return !1
}
document.layers ? (document.captureEvents(Event.MOUSEDOWN), document.onmousedown = n) : (document.onmouseup = n, document.oncontextmenu = function n() {
